...
public class Activity5 {
    WebDriver driver;
    //Include alwaysRun property on the @BeforeTest to make sure the page opens
    ...
    public void HeaderTest2() {
        WebElement header5 = driver.findElement(By.xpath("//h5"));
        System.out.println("Color of header h5: " + header5.getCssValue("color"));
